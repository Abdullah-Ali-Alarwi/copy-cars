...
// export default function InternalColorFilter({ title, icon}: FilterSectionProps) {
...
//     { type: "Custom", color: customColor }, // اللون الأخير مخصص
//   ];
...
//                 onChange={() => setSelectedColor(item.type)}
//                 className="hidden"
//               />
...
//                       : "border-gray-300"
//                   }`}
//                 onClick={() => setSelectedColor(item.type)}
//               >
//                 {/* الدائرة الملونة */}
//                 <div
